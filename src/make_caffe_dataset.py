...
if __name__ == "__main__":
    ...
    #font_dir = os.path.expanduser("/home/user/Projects/chinese_id_card_ocr/chinese_fonts/")
    font_dir = os.path.expanduser("/home/user/Projects/chinese_id_card_ocr/id_num_fonts/")
